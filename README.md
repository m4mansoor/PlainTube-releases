...
| Windows (Installer) | [PlainTube-0.1.0-win-x64-setup.exe](https://github.com/m4mansoor/PlainTube-releases/releases/latest/download/PlainTube-0.1.0-win-x64-setup.exe) |
| Windows (Portable) | [PlainTube-0.1.0-win-x64-portable.exe](https://github.com/m4mansoor/PlainTube-releases/releases/latest/download/PlainTube-0.1.0-win-x64-portable.exe) |
